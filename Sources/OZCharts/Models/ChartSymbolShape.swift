...
public struct CustomSymbolPath: Hashable {
    ...
    public static func == (lhs: CustomSymbolPath, rhs: CustomSymbolPath) -> Bool {
        lhs.id == rhs.id
    }
...
public enum ChartSymbolShape: Hashable {
    ...
    public static func custom(
        ...
        _ draw: @escaping (CGRect) -> Path
    ) -> ChartSymbolShape {
        .customShape(CustomSymbolPath(id: id, draw: draw))
    }
    ...
    public func path(in rect: CGRect) -> Path {
        ...
        case .customShape(let custom):
            return custom.draw(rect)
        }
        return path
    }
}
